...
// If true, then a-y additional include russian letter '?',
// A-? additional include '?', and a-? include all russian symbols.
...
RusRangeLoLow = #$430{'a'};
RusRangeLoHigh = #$44F{'y'};
RusRangeHiLow = #$410{'A'};
RusRangeHiHigh = #$42F{'?'};
{$ELSE}
RusRangeLo = 'aaaaaa??ceeeeiiii?nooooo?ouuuuy?y';
RusRangeHi = 'AAAAAA??CEEEEIIII?NOOOOO?OUUUUY??';
RusRangeLoLow = 'a';
RusRangeLoHigh = 'y';
RusRangeHiLow = 'A';
RusRangeHiHigh = '?';
...
!! startp/endp ana ?aaii aoaao iianii eniieuciaaou ?
}
